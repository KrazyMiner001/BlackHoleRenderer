...
pub mod bind_groups {
    ...
    pub struct BindGroupLayout0<'a> {
        pub in_data: wgpu::BufferBinding<'a>,
        pub out_data: wgpu::BufferBinding<'a>,
    }
        ...
        pub fn from_bindings(device: &wgpu::Device, bindings: BindGroupLayout0) -> Self {
            ...
            let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    wgpu::BindGroupEntry {
                        binding: 0,
                        resource: wgpu::BindingResource::Buffer(bindings.in_data),
                    },
                    wgpu::BindGroupEntry {
                        binding: 1,
                        resource: wgpu::BindingResource::Buffer(bindings.out_data),
                    },
                ],
...
pub const SOURCE: &str = include_str!("simple.wgsl");
